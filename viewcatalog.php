...
$sid=$_GET['sid'];
$selectCatalog=mysqli_query($con,"SELECT cID from catalog where uID='$sid'");
$catalogID=mysqli_fetch_array($selectCatalog)['cID'];
$selectCategories=mysqli_query($con,"SELECT * from category where catalogID='$catalogID'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Catalog</title>
    <link rel="stylesheet" href="viewcatalog.css">
...
<div id="nav">
    ...
    <h1 class="title">Supplier Catalog</h1>
    <div class="catalog">
        <?php
            while($category=mysqli_fetch_array($selectCategories)){
                echo "<div class='category'>";
                    echo "<h2>".$category['Name']."</h2>";
                    $selectCatProducts=mysqli_query($con,"SELECT * from category_products where catID='".$category['categoryID']."'");
                    while($catProduct=mysqli_fetch_array($selectCatProducts)){
                        $selectProduct=mysqli_query($con,"SELECT * from Product where pID='".$catProduct['pID']."'");
                        $product=mysqli_fetch_array($selectProduct);
                        echo "<div class='product'>";
                            echo "<div class='pname'>".$product['Name']."</div>";
                            echo "<div class='minQuantity'>Min:".$product['MinQuantity']."</div>";
                            echo "<div class='maxQuantity'>Max:".$product['MaxQuantity']."</div>";
                            echo "<div class='pprice'>Price: ".$product['Price']."$</div>";
                            echo "<div class='view'><a href='viewproduct.php?pid=".$product['pID']."'>View Product</a></div>";
                        echo "</div>";
                    }
                echo "</div>";
            }
